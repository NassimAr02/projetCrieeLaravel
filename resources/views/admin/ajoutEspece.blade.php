    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                ...
                <form action="{{ route('admin.ajoutEspece.store') }}" method="POST" class="p-6">
                    @csrf
                    ...
                    <div class="max-w-3xl mx-auto space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="nomEspece" class="block text-sm font-medium text-gray-700 mb-1">
                                    Nom espèce 
                                </label>
                                <input type="text" id="nomEspece" name="nomEspece" required
                            ...
                            <div class="space-y-2">
                                <label for="nomScientifiqueEspece" class="block text-sm font-medium text-gray-700 mb-1">
                                    Nom scientifique espèce 
                                </label>
                                <input type="text" id="nomScientifiqueEspece" name="nomScientifiqueEspece" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border">
                            </div>
                            <div class="space-y-2">
                                <label for="nomCommunEspece" class="block text-sm font-medium text-gray-700 mb-1">
                                    Nom Commun espèce 
                                </label>
                                <input type="text" id="nomCommunEspece" name="nomCommunEspece" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 py-2 px-3 border">
                            </div>
                        </div>
